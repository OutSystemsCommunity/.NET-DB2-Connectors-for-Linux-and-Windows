...
namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.ExecutionService
{

	[DoNotObfuscate]
	public class DB2LUWExecutionService : BaseExecutionService
	{
        
		public DB2LUWExecutionService(IDatabaseServices databaseServices) : base(databaseServices) {}
