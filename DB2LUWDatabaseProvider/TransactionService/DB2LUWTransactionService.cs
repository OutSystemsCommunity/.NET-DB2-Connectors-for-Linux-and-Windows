...
namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.TransactionService
{
    [DoNotObfuscate]
    public class DB2LUWTransactionService : BaseTransactionService {

        public DB2LUWTransactionService(IDatabaseServices databaseServices) : base(databaseServices) { }
        ...
        public override IDbTransaction CreateTransaction(IDbConnection conn) {
            if (((DB2LUWRuntimeDatabaseConfiguration)base.DatabaseServices.DatabaseConfiguration).AutoCommit) {
