...
using System.Text;
using OutSystems.HubEdition.DatabaseProvider.DB2LUW.Extensions;
using System;

namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.ConfigurationService
{
    [DoNotObfuscate]
    public class DB2LUWDatabaseConfiguration : BaseDatabaseConfiguration
    {

        public override IDatabaseProvider DatabaseProvider { get { return DB2LUWIntegrationDatabaseProvider.Instance; } }
        ...
        {
            DB2LUWDatabaseConfiguration config = obj as DB2LUWDatabaseConfiguration;
        ...
        protected override string AssembleBasicConnectionString()
        {
            ...
            sb.AppendConnectionStringParam(DB2LUWIDs.DATA_SOURCE, DataSource);
            sb.AppendConnectionStringParam(DB2LUWIDs.DATABASE, Database);
            sb.AppendConnectionStringParam(DB2LUWIDs.USERNAME, UserID);
            sb.AppendConnectionStringParam(DB2LUWIDs.PASSWORD, Password);
            sb.AppendConnectionStringParam(DB2LUWIDs.SCHEMA, Schema);
        ...
        private static string AssembleAdvanceConfigTemplate()
        {
            ...
            sb.Append("[");
            sb.AppendConnectionStringParam(DB2LUWIDs.USERNAME, "$UserID");
            sb.AppendConnectionStringParam(DB2LUWIDs.PASSWORD, "<hidden>");
            sb.Append("]");
        ...
        public override IRuntimeDatabaseConfiguration RuntimeDatabaseConfiguration
        {
            get
            {
                return new DB2LUWRuntimeDatabaseConfiguration
                {
                    Username = UserID,
                    Schema = Schema,
