...
namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.DatabaseObjects {
    public class DB2LUWTableSourceForeignKeyInfo : ITableSourceForeignKeyInfo {

        public DB2LUWTableSourceForeignKeyInfo(ITableSourceInfo tableSource, string name, string columnName, ITableSourceInfo referencedTableSource, string referencedColumnName, bool isCascadeDelete) {
