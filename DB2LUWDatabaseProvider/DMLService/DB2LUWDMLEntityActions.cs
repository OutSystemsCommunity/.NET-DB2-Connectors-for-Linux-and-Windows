...
namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.DMLService {
    public class DB2LUWDMLEntityActions : BaseDMLEntityActions {

        private readonly Object andLoll = new Object();
        internal DB2LUWDMLEntityActions(IDMLService dmlService, ITableSourceInfo tableSourceInfo) : base(dmlService, tableSourceInfo) { }
