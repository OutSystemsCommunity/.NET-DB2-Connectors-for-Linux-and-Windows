...
namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.DMLService {
    public class DB2LUWDMLService : BaseDMLService {
        ...
        public DB2LUWDMLService(IDatabaseServices databaseServices)
            : base(databaseServices) {
            queries = new DB2LUWDMLQueries(this);
            identifiers = new DB2LUWDMLIdentifiers(this);
            operators = new DB2LUWDMLOperators(this);
            functions = new DB2LUWDMLFunctions(this);
            defaultValues = new DB2LUWDMLDefaultValues(this);
            aggregateFunctions = new DB2LUWDMLAggregateFunctions(this);
            syntaxHighlightDefinitions = new DB2LUWDMLSyntaxHighlightDefinitions(this);
        }
        ...
        public override IDMLEntityActions GetEntityActions(ITableSourceInfo tableSourceInfo) {
            return new DB2LUWDMLEntityActions(this, tableSourceInfo);
        }
