...
namespace OutSystems.HubEdition.DatabaseProvider.DB2LUW.DMLService {
    public class DB2LUWDMLSyntaxHighlightDefinitions : GenericDMLSyntaxHighlightDefinitions {

        public DB2LUWDMLSyntaxHighlightDefinitions(DB2LUWDMLService dmlService) : base(dmlService) { }
